...
def _load_pymomentum_model_fitting() -> type:
    from pymomentum_fitting import PyMomentumModelFitting

    return PyMomentumModelFitting
...
class Conversion:
    ...
    def _s2m_fit_mhr_using_pymomentum(
        ...
        if self.pymomentum_solver is None:
            PyMomentumModelFitting = _load_pymomentum_model_fitting()
