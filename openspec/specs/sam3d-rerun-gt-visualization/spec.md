...
The SAM-3D-Body rerun visualization SHALL log GT keypoints when GT keypoint annotations are present in the selected dataset sample.
...
The SAM-3D-Body rerun visualization SHALL emit metadata indicating whether GT keypoints and GT mesh were logged for the sample.
