...
Define the expected behavior for generating per-image SAM3 person masks for Panoptic RGB sequences and storing them under each sequence directory for reuse in preprocessing and dataset pipelines.
