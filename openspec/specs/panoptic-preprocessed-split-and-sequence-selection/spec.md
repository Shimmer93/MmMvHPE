# panoptic-preprocessed-split-and-sequence-selection Specification

## Purpose
TBD - created by archiving change panoptic-preprocessed-dataset-v3-interface. Update Purpose after archive.
## Requirements
