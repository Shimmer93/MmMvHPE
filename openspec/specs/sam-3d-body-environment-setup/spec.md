# Capability: sam-3d-body-environment-setup

## Purpose
Define a reproducible, GPU-required SAM-3D-Body environment setup within MMHPE, with explicit checkpoint path contracts and preflight validation behavior.
