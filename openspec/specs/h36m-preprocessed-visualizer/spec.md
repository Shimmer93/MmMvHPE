# Capability: h36m-preprocessed-visualizer

## Purpose
Provide a visualization script for the preprocessed H36M multiview dataset that overlays
2D keypoints on RGB views and shows the GT 3D skeleton.
