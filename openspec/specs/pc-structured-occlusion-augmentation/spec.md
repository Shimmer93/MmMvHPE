# pc-structured-occlusion-augmentation Specification

## Purpose
Define runtime structured LiDAR occlusion augmentation for training pipelines without requiring new dataset artifacts.
