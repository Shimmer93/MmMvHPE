...
The preprocessed H36M dataset SHALL be stored under a root directory with modality subfolders (e.g., `rgb/`, `gt/`, and optional metadata) to enable fast loading.
...
The RGB frames SHALL be stored as JPEG at 480x640; 3D joint arrays SHALL be stored in compact NumPy format (float16) for SSD efficiency.
